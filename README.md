...
```bash
$ echo "python $(pwd)/src/data/make.py"
python /home/user/path/to/rapidpro-mormalizer/src/data/make.py
$
```
...
```
0 1 * * * python /home/user/path/to/rapidpro-mormalizer/src/data/make.py
```
This gives instruction to the cron daemon to run the `python /home/user/path/to/rapidpro-mormalizer/src/data/make.py` command every day of week, every month, every day of month at 1:00 AM. 